...
public class Profesor extends Persona {     //Se crea una subclase profesor de la clase persona
    ...
    public Profesor(String name, String LastName, int age){     //Constructor de la clase profesor que tiene como parametros las variables privadas de la clase persona
    ...
    public void setIdProfesor(String IdProfesor){   //Metodo setIdProfesor de tipo String con modificador de acceso publico con parametros el atributo privado de la clase profesor
        this.IdProfesor = IdProfesor;   //Se utiliza this para acceder a la variable privada "oculta" IdProfesor
    }
    
    public String getIdProfesor(){    //Metodo setIdProfesor de tipo String con modificador de acceso publico sin parametros
        return IdProfesor;      //Regresa el contenido de la variable IdProfesor
    }
    
    public void Show(){     //Metodo  Show de topo void con modificador de acceso public sin parametros
