...
public class Persona {  //Se crea una clase persona con modificador de acceso public
    ...
    public Persona (String name, String LastName, int age) {    //Constructor de la clase que tiene como parametros las variable privadas de la clase
    ...
    public String getName(){    //Metodo getName de tipo String con modificador de acceso publico sin parametros
        return name;    //Regresa el contenido de la variable name
    }
    
    public String getLastName(){    //Metodo getLastName de tipo String con modificador de acceso publico sin parametros
        return LastName;    //Regresa el contenido de la variable LastName
    }
    
    public int getAge(){    //Metodo getAge de tipo entero con modificador de acceso publico sin parametros
