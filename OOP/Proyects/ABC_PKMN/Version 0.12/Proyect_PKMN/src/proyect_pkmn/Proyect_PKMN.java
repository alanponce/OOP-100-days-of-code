...
public class Proyect_PKMN {
    ...
    public static void main(String[] args) {
        ...
        Pokemon pikachu = new Pokemon(name,hp,10,10,10);
        // Probando la función setATK
        pikachu.setATK(50);
        // String planeada para imprimir las estadisticas
      //  String Stats = "Name:"+pikachu.getName()+"\rHP: "+pikachu.getHP()+"\rATK: "+pikachu.getATK()+"\rDEF: "+pikachu.getDEF()+"\rVEL: "+pikachu.getVEL();
        try{
        ...
        */
        BufferedWriter wr = new BufferedWriter(new FileWriter(pokedex)); // File Writer nos permite escribir en un archivo  
