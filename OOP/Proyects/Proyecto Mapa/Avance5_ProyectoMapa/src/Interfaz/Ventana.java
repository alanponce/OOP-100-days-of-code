...
//Creamos un metodo con una entrada booleana para poder deshabilitar y ocultar las tablas
    ...
    private void Rastreo(boolean falso)
    {
        ...
        this.lblRegla.enable(falso);
        this.lblRegla.show(falso);
        this.lblReglas2.enable(falso);
        this.lblReglas2.show(falso);
        //textbox
    ...
    //Creamos un metodo que nos abrira el navegador y nos redirecciona a una pagina
    private void Navegador1(String lugar)
    {
        //Este try nos direcciona a la url en el navegador
        try {
            Desktop.getDesktop().browse(new URL(lugar).toURI());
    ...
    private void initComponents() {
        ...
        lblRegla = new javax.swing.JLabel();
        ...
        getContentPane().add(btnUbicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 520, -1, -1));
        ...
        getContentPane().add(btnRecorrido, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 520, -1, -1));
        ...
        getContentPane().add(btnLocalizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 240, -1, -1));
        ...
        lblRegla.setText("La ubicacion debe contener:");
        getContentPane().add(lblRegla, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, -1, 20));

        lblIngrese.setText("Ingrese su ubicacion:");
        getContentPane().add(lblIngrese, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 180, -1, -1));

        tbUbicacion.setText("Ejemplo:henequen+9534");
        tbUbicacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tbUbicacionActionPerformed(evt);
            }
        });
        getContentPane().add(tbUbicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 190, -1));

        lblReglas2.setText("Calle y # de domicilio separado con +");
        getContentPane().add(lblReglas2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, -1, -1));
    ...
    private void btnLocalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocalizarActionPerformed
       //Estos switches nos ayudan a determinar que url abrir en cualquier caso
        switch(this.lblStatus.getText())
            {
                case "Aztecas":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.6620202,-106.4726568";
                    Navegador1(Localizacion);
                    break;
                case "Carlos Amaya":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.6960171,-106.4820059";
                    Navegador1(Localizacion);
                    break;
                case "Centro":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.7387286,-106.4844009";
                   Navegador1(Localizacion);
                   break;
                case "Independencia":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                ...
                case "Panamericana":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.65621,-106.4308213";
                    Navegador1(Localizacion);
                    break;
                case "Plaza del Reloj":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.6622238,-106.3930957";
                    Navegador1(Localizacion);
                    break;
                case "Plaza Juarez":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.7056663,-106.4259918";
                    Navegador1(Localizacion);
                    break;
                case "Plaza las Torres":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.6225826,-106.3943623";
                    Navegador1(Localizacion);
                    break;
                case "Plaza Sendero":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.6922341,-106.3825022";
                    Navegador1(Localizacion);
                    break;
                case "Porvenir":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.7050374,-106.4018729";
                    Navegador1(Localizacion);
                    break;
                case "Rayon y Lucero":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.6274441,-106.372479";
                    Navegador1(Localizacion);
                    break;
                case "Torres Henequen":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.6494885,-106.3889386";
                    Navegador1(Localizacion);
                    break;
                case "Torres Libramiento":
                    //Esta variables nos ayuda a determinar el camino de tu casa a la parada
                    Localizacion = "https://www.google.com.mx/maps/dir/" + this.tbUbicacion.getText() + "/31.6058216,-106.3990229";
                    Navegador1(Localizacion);
                    break;
        }
    ...
    private void btnRecorridoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecorridoActionPerformed
       //Estos switches nos ayudan a determinar que url abrir en cualquier caso
        ...
        {
            case "Aztecas":
                    Navegador1("https://www.google.com.mx/maps/dir/Ciudad+Universitaria+edificio+B,+Ciudad+Ju%C3%A1rez,+Chih./Coppel+Aztecas/@31.5814109,-106.5719991,11z/data=!3m1!4b1!4m13!4m12!1m5!1m1!1s0x86e764eb800a2325:0xfa28fa2110f1714!2m2!1d-106.4140104!2d31.4938195!1m5!1m1!1s0x86e75e46eef772e3:0xb9201f334cc78ff7!2m2!1d-106.4724865!2d31.6615309");
                    break;
            case "Carlos Amaya":
                    Navegador1("https://www.google.com.mx/maps/dir/Ciudad+Universitaria+edificio+B,+Ciudad+Ju%C3%A1rez,+Chih./31.6959478,-106.4820112/@31.6237953,-106.557617,11z/data=!3m1!4b1!4m8!4m7!1m5!1m1!1s0x86e764eb800a2325:0xfa28fa2110f1714!2m2!1d-106.4140104!2d31.4938195!1m0");
                    break;
            case "Centro":
                   ...
                   break;
            case "Independencia":
                    Navegador1("https://www.google.com.mx/maps/@31.6259389,-106.3540675,3a,75y,80.03h,76.98t/data=!3m6!1e1!3m4!1sl6eKz7x7w5qyRznzpPkqYg!2e0!7i13312!8i6656");
                    break;
            case "Panamericana":
                    Navegador1("https://www.google.com.mx/maps/dir/Ciudad+Universitaria+edificio+B,+Ciudad+Ju%C3%A1rez,+Chihuahua/31.6569464,-106.4314551/@31.5749486,-106.4803074,12z/data=!3m1!4b1!4m8!4m7!1m5!1m1!1s0x86e764eb800a2325:0xfa28fa2110f1714!2m2!1d-106.4140104!2d31.4938195!1m0");
                    break;
            case "Plaza del Reloj":
                    ...
                    break;
            case "Plaza Juarez":
                    Navegador1("https://www.google.com.mx/maps/@31.7057122,-106.4260768,3a,75y,180.94h,84.88t/data=!3m6!1e1!3m4!1sYJMBrQnH3in3ULbFmzZJKQ!2e0!7i13312!8i6656");
                    break;
            case "Plaza las Torres":
                    Navegador1("https://www.google.com.mx/maps/dir/Ciudad+Universitaria+edificio+B,+Ciudad+Ju%C3%A1rez,+Chih./Provive/@31.5571962,-106.4637933,12z/data=!3m1!4b1!4m13!4m12!1m5!1m1!1s0x86e764eb800a2325:0xfa28fa2110f1714!2m2!1d-106.4140104!2d31.4938195!1m5!1m1!1s0x0:0x41639c736cca3d2d!2m2!1d-106.3961736!2d31.6230604");
                    break;
            case "Plaza Sendero":
                    Navegador1("https://www.google.com.mx/maps/dir/Ciudad+Universitaria+edificio+B,+Ciudad+Ju%C3%A1rez,+Chihuahua/31.692365,-106.3823795/@31.5924775,-106.5236401,11z/data=!3m1!4b1!4m8!4m7!1m5!1m1!1s0x86e764eb800a2325:0xfa28fa2110f1714!2m2!1d-106.4140104!2d31.4938195!1m0");
                    break;
            case "Porvenir":
                    Navegador1("https://www.google.com.mx/maps/dir/Ciudad+Universitaria+edificio+B,+Ciudad+Ju%C3%A1rez,+Chih./''/@31.6012749,-106.5169455,11z/data=!3m1!4b1!4m13!4m12!1m5!1m1!1s0x86e764eb800a2325:0xfa28fa2110f1714!2m2!1d-106.4140104!2d31.4938195!1m5!1m1!1s0x0:0xd279c341609c048f!2m2!1d-106.4024064!2d31.705352");
                    break;
            case "Rayon y Lucero":
                    ...
                    break;
            case "Torres Henequen":
                    Navegador1("https://www.google.com.mx/maps/dir/31.6495287,-106.3889386/31.4927427,-106.4138476/@31.5474312,-106.4668231,12.04z/data=!4m2!4m1!3e0");
                    break;
            case "Torres Libramiento":
                    Navegador1("https://www.google.com.mx/maps/dir/Ciudad+Universitaria+edificio+B,+Ciudad+Ju%C3%A1rez,+Chih./31.6065209,-106.3990941/@31.5489522,-106.4637933,12z/data=!3m1!4b1!4m8!4m7!1m5!1m1!1s0x86e764eb800a2325:0xfa28fa2110f1714!2m2!1d-106.4140104!2d31.4938195!1m0");
                    break;
        }
    ...
    private void btnUbicacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbicacionActionPerformed
        ...
        switch(this.lblStatus.getText())
            {
                case "Aztecas":
                    Navegador1("https://www.google.com.mx/maps/@31.6620508,-106.4726488,3a,75y,185.1h,90.7t/data=!3m6!1e1!3m4!1s5aFDHdKhg9apj0hcpK1tQw!2e0!7i13312!8i6656");
                    break;
                case "Carlos Amaya":
                    Navegador1("https://www.google.com.mx/maps/@31.6960013,-106.4820112,3a,75y,228.85h,90.69t/data=!3m6!1e1!3m4!1sEsMPrJfUJARZul0NwQQ2rg!2e0!7i13312!8i6656");
                    break;
                case "Centro":
                   Navegador1("https://www.google.com.mx/maps/@31.738736,-106.4844212,3a,75y,127.55h,91.93t/data=!3m6!1e1!3m4!1scQGHqJjxyKA4Ffj0PryTlg!2e0!7i13312!8i6656");
                   break;
                case "Independencia":
                    Navegador1("https://www.google.com.mx/maps/@31.6259389,-106.3540675,3a,75y,80.03h,76.98t/data=!3m6!1e1!3m4!1sl6eKz7x7w5qyRznzpPkqYg!2e0!7i13312!8i6656");
                    break;
                case "Panamericana":
                    Navegador1("https://www.google.com.mx/maps/@31.6562202,-106.4307287,3a,75y,35.31h,81.58t/data=!3m6!1e1!3m4!1scsxonokFvKDOi1Ho3erZ8A!2e0!7i13312!8i6656");
                    break;
                case "Plaza del Reloj":
                    Navegador1("https://www.google.com.mx/maps/@31.6622975,-106.3930108,3a,75y,17.97h,79.78t/data=!3m6!1e1!3m4!1sB2SOHXUM7c_EwOYYkNVWxw!2e0!7i13312!8i6656");
                    break;
                case "Plaza juarez":
                    Navegador1("https://www.google.com.mx/maps/@31.7057122,-106.4260768,3a,75y,180.94h,84.88t/data=!3m6!1e1!3m4!1sYJMBrQnH3in3ULbFmzZJKQ!2e0!7i13312!8i6656");
                    break;
                case "Plaza las Torres":
                    Navegador1("https://www.google.com.mx/maps/@31.6225983,-106.3944445,3a,75y,222.05h,86.82t/data=!3m6!1e1!3m4!1s03jf6K6N-MNfew5UCveUSg!2e0!7i13312!8i6656");
                    break;
                case "Plaza Sendero":
                    Navegador1("https://www.google.com.mx/maps/@31.6922964,-106.3823878,3a,75y,35.32h,70.21t/data=!3m6!1e1!3m4!1s40YRe4_OG2hG8Kg3NVb5Aw!2e0!7i13312!8i6656");
                    break;
                case "Porvenir":
                    Navegador1("https://www.google.com.mx/maps/@31.7051006,-106.4018142,3a,75y,217.93h,72.96t/data=!3m6!1e1!3m4!1siqLUesX-jcHpnLUe9fPeZg!2e0!7i13312!8i6656");
                    break;
                case "Rayon y Lucero":
                    Navegador1("https://www.google.com.mx/maps/@31.6275471,-106.3724378,3a,75y,115.75h,77.03t/data=!3m6!1e1!3m4!1s461EH6bOYC_PXADMC9vZww!2e0!7i13312!8i6656");
                    break;
                case "Torres Henequen":
                    Navegador1("https://www.google.com.mx/maps/@31.6495515,-106.3889821,3a,75y,222.8h,80.13t/data=!3m6!1e1!3m4!1sLpseY8icx4xXkuKYNj9PuA!2e0!7i13312!8i6656");
                    break;
                case "Torres Libramiento":
                    Navegador1("https://www.google.com.mx/maps/@31.605935,-106.3990186,3a,75y,109.22h,73.28t/data=!3m6!1e1!3m4!1sJsArOU8dI7q48LFrDkT1tA!2e0!7i13312!8i6656");
                    break;
        }
    ...
    private javax.swing.JLabel lblRegla;
