...
a)Los costos tendran variacion dependidendo del tipo de habitacion a reservar, metodos de pago los cuales podran ser a traves de transaccion bancarea siendo todo esto en precencial al acudir al lugar (aqui me da la idea de que cambia costo con netdo de pago).
...
c)La autitificacion (autentificacion) del cliente se efectual al momento posterior al pago final.
