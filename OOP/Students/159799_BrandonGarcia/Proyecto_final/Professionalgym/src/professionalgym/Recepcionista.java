...
public class Recepcionista extends Empleado implements OperacionesEmpleado{/*creacion de una subclase que hereda de la clase 'Empleado' con el fin de utilizar sus atributos
    ademas esta clase implementa metodos de la clase 'OperacionesEmpleado'*/
    
    public Recepcionista(int Id, String Nombre, String Direccion, String Telefono) {//Instanciacion del constructor de la clase con sus respectivos parametros.
