...
public class JugadorEscolta extends Jugador{/*Se crea la clase JugadorEscolta, la cual hereda atributos y
   ...
   @Override
    ...
    public void Jugar(){/*El método Jugar hace que el jugador tome una desición en cuanto a lo que
        ...
        switch (Jugador.getDecision()){/*Dependiendo del número generado, el jugador hará alguno 
