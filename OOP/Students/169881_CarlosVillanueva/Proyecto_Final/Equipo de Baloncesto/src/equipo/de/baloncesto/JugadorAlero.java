...
public class JugadorAlero extends Jugador implements Jugadas {/*Se crea la clase JugadorAlero, la cual hereda atributos
   de la clase padre Jugador y métodos de la interfaz Jugadas.*/
    
   public JugadorAlero(String Nombre, String Posicion, boolean Visitante, int Estatura, int NivelPase, int NivelTiro){
