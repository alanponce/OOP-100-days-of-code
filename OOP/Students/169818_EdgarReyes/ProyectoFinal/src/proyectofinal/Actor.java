...
public class Actor extends Persona implements manejarRegistros {
 //Declaracion de la clase Actor que hereda metodos y atributos de la clase Persona, también implementa los metodos de la interfaz manejarRegistros

    
    /*Atributos de la clase. Son declarados como privados para que nada fuera de la clase los pueda modificar.*/
    private String peliculasActuadas; //Declaracion de la variable peliculasActuadas de tipo String.
    ...
    Actor(String peliculasActuadas){
    ...
    //Metodo de la clase que regresa el valor de la variable peliculasActuadas.
    public String getPeliculasActuadas() {
        
        return peliculasActuadas;
    }

    //Metodo de la clase que toma como parametro un variable tipo String y se la asigna a la variable peliculasActuadas.
    ...
    private String lugarNacimiento;*/
        ...
        System.out.println("Peliculas actuadas: " + getPeliculasActuadas());    //Imprime las peliculas actuadas concatenando el valor devuelto por el metodo de la misma clase Actor.
    }
    ...
    public void crearRegistro(){
        ...
        System.out.println("Ingrese una pelicula en donde el actor actuó: "); //Imprime un mensaje solicitando al usuario que ingrese una pelicula donde haya actuado el actor.
        String peliculaActuada = input.nextLine(); //Asigna a la variable peliculaActuada lo que el usuario teclee.
        setPeliculasActuadas(peliculaActuada); //Usando el método de la misma clase Actor se le establece las peliculas actuadas al objeto.
    }
