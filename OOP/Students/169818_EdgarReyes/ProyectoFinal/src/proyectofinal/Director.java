...
public class Director extends Persona implements manejarRegistros {
//Declaracion de la clase Director que hereda metodos y atributos de la clase Persona, también implementa los metodos de la interfaz manejarRegistros
    
    /*Atributos de la clase. Son declarados como privados para que nada fuera de la clase los pueda modificar.*/
    private String peliculasDirigidas;  //Declaracion de la variable peliculasDirigidas de tipo String.
    ...
    Director(String peliculaDirigida){
        ...
        this.peliculasDirigidas = peliculaDirigida;
    }
    
    //Metodo de la clase que regresa el valor de la variable peliculasDirigidas.
    public String getPeliculasDirigidas() {
        return peliculasDirigidas;
    }

    //Metodo de la clase que toma como parametro un variable tipo String y se la asigna a la variable peliculasDirigidas.
    ...
    private String lugarNacimiento;*/
        ...
        System.out.println("Peliculas dirigidas: " + getPeliculasDirigidas());    //Imprime las peliculas dirigidas concatenando el valor devuelto por el metodo de la misma clase Director.
    }
    ...
    public void crearRegistro(){
        ...
        String peliculaDirigida = input.nextLine(); //Asigna a la variable peliculaDirigda lo que el usuario teclee.
        setPeliculasDirigidas(peliculaDirigida); //Usando el método de la misma clase Director se le establece las peliculas actuadas al objeto.
    }
