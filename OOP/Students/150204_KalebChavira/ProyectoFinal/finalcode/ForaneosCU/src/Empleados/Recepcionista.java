 ...
 * @author compu
 */
public class Recepcionista extends Empleado {//clase recepcionista que hereda los atributos y metodos de empleado
 ...
 private void Create(){
     System.out.println("El recepcionista despues del login tiene acceso al create");
}
