 ...
 * @author compu
 */
public class SuitNupcial extends Suit {//clase que hereda de la clase suit
     String Nombre = "Suit Nupcial";//nombre de la habitacion
    int precio = 2500;//precio de la habitacion en pesos mexicanos
