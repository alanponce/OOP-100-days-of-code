 ...
 * @author compu
 */
public class Individual extends Habitaciones {//clase individual que hereda de habitaciones

    String Nombre = "Individual";//nombre de la habitacion
    int precio = 500;//precio de la habitacion en pesos mexicanos
    int capacidad = 1;//capacidad de la habitacion en personas
