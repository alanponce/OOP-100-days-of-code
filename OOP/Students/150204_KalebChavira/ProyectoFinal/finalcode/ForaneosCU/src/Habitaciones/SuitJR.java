 ...
 */
package Habitaciones;//clase que pertence al paquete de habitaciones

/**
 *
 * @author compu
 */
public class SuitJR extends Suit//clase que hereda de suit
{
     String Nombre = "Suit Junior";//nombre de la habitacion
    int precio = 2200;//precio de la habitacion en pesos mexicanos
    int capacidad = 5;//capacidad de la habitacion en personas
