 ...
 * @author compu
 */
public class LogIn extends javax.swing.JFrame { // clase principal que se declara publica llamada login  que hereda de java swing.Jframe 

    private String NUser1, NAdmin, PWUser1, PWAdmin; // se declaran variables que son de tipo string con modificador de private
   
    
    public LogIn() { // se declara el constructor de la clase principal login 
        initComponents(); //constructor que inicializa componentes 
    ...
    NAdmin=   "stytech";
    PWAdmin = "stytech159872";
    NUser1 ="usuario";
    PWUser1= "usuario159872";
